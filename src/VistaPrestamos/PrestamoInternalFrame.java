 ...
 * @author carlos
 */
public class PrestamoInternalFrame extends javax.swing.JInternalFrame {

    private Principal principal;

    /**
     * Creates new form prestamoInternalFrame
     */
    public PrestamoInternalFrame(Principal p) {
        initComponents();
        this.principal = p;
    ...
    private void registrar() {
        ...
        if (!this.validarCampos()) {
            ...
            boolean resul = this.principal.getFachada().registrarPrestamo(prestamo);
            if(resul){
