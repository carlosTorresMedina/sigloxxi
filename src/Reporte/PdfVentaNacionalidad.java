 ...
 * @author carlos
 */
public class PdfVentaNacionalidad {
   ...
   private String nacionalidad;
    ...
    public PdfVentaNacionalidad(){
     this.ruta="c:\\Reportes\\VentaNacionalidad\\";
     ...
     * @return
     */
    public boolean generarPDFFactura(String fechaI, String fechaF, ArrayList<InformeGeneralDto> nochePesos, ArrayList<InformeGeneralDto> diaPesos, ArrayList<InformeGeneralDto> nocheBolivares, ArrayList<InformeGeneralDto> diaBolivares,String nacionalidadd) {
        ...
        this.nacionalidad=nacionalidadd;
